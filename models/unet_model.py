...
[1] https://github.com/labmlai/annotated_deep_learning_paper_implementations/blob/master/labml_nn/diffusion/ddpm/unet.py
---
...
class UNet(nn.Module):
    ...
    def forward(self, x: torch.Tensor, t: torch.Tensor, c: Optional[torch.Tensor] = None):
        ...
        * `c` is not used, but it is defined for consistency
        """
